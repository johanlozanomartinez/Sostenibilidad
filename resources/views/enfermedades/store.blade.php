...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">10) PLAGAS ENFERMEDADES</h4>

            </div>
            <div class="card-body">
            
            <form action="/plagas" method="POST">
            @csrf
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="number" step="any" class="form-control"  name="asociacion_municipio" min="0" max="10000" required>
    </div>   

    <div class="form-group">
      <label>Promedio (Captura/Infestación)</label>
      <input type="number" step="any" class="form-control"  name="asociacion_participa" min="0" max="10000" required>
    </div>  
  </div>
          ...
          $(document).ready(function(){
              ...
              var faculty_id =  $('#faculty_id').val();
                  ...
                  if($.trim(faculty_id) != ''){
                      ...
                      $.each(Creaers,function(index,value){

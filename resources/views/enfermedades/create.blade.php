    ...
    <div class="row">
      ...
      <div class="form-group">
          <label>Enfermedades</label>
              <select id="id"  name="career_id" class="form-control">
                <option>   
                </option>
              </select>
          </div>
        ...
        <div class="form-group">
          ...
          <input type="number" step="any" class="form-control"  name="valor_referencia" min="0" max="10000" required>
        </div>   
    
        <div class="form-group">
          <label>Promedio (Captura/Infestación)</label>
          <input type="number" step="any" class="form-control"  name="promedio" min="0" max="10000" required>
        </div>  
      </div>

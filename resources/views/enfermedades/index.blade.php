                    ...
                    <div class="collapse show" id="laravelExample">
                      <ul class="nav">
                        ...
                        <li class="nav-item active  ">
                          <a class="nav-link" href="{{ route('enfermedades.create') }}">
                            <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR 5) Plagas Enfermedades </h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/enfermedades" class="btn btn-sm btn-primary">Agregar Plagas Enfermedades</a>
                </div>
              </div>
              <div class="table-responsive">
                ...
                <!---Listar Usuarios-->
                      ...
                      <tbody> 
                        @foreach($enfermedades as $fn)
                        <tr>
                        <td>{{$fn->id}}</td>
                        <td>{{($fn->NombreFacultad)}}</td>
                        <td>{{($fn->NombreCarrera)}}</td>
                        <td>{{($fn->valor_referencia)}}</td>
                        <td>{{$fn->promedio}}</td>
                        <td>{{$fn->desempeño}}</td>
                        
                          <td>{{$fn->NombreFinca}}</td>

                          <td><a type="button" href="{{route('enfermedades.edit',$fn->id)}}" class="btn btn-primary">Edit</a>  </td>

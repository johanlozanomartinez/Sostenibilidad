...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">13) DEPENDENCIA A INSUMOS EXTERNOS</h4>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label>Costo Insumos Internos</label>
      <input type="number" step="any" class="form-control"  name="costo_interno" min="0" required>
    </div>   

      
    
    <div class="form-group">
      <label>Costo Insumos Externos</label>
      <input type="number" step="any" class="form-control"  name="costo_externo" min="0" required>
    </div>   

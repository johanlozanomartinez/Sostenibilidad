      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR 13) DEPENDENCIA A INSUMOS EXTERNOS</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/dependencias/create" class="btn btn-sm btn-primary">Agregar  DEPENDENCIA A INSUMOS EXTERNOS</a>
                </div>
              </div>
              <div class="table-responsive">
                ...
                <!---Listar Usuarios-->
                  ...
                  <tbody> 
                    ...
                    <td>{{$fn->id_dependencias}}</td>
                    <td>{{number_format($fn->costo_interno)}}</td>
                    <td>{{number_format($fn->costo_externo)}}</td>
                    <td>{{number_format($fn->total)}}</td>
                    <td>{{$fn->dependencia}}</td>
                    <td>{{$fn->desempeño}}</td>
                      <td>{{$fn->IdUnidad}}</td>

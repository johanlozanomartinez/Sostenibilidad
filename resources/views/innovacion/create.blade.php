...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">11) INNOVACIÓN TECNOLÓGICA</h4>

            </div>
            <div class="card-body">
            
            <form action="/innovacion" method="POST">
            @csrf
  <div class="form-group">
    ...
    <div class="form-group">
      <label>No Prácticas o Tecnologías Innovadoras</label>
      <input type="number" step="any" class="form-control"  name="practicas" min="0" max="10000" required>

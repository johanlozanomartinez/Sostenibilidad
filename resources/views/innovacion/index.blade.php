      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR 11) INNOVACIÓN TECNOLÓGICA</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/innovacion/create" class="btn btn-sm btn-primary">Agregar  INNOVACIÓN TECNOLÓGICA</a>
                </div>
              </div>
              <div class="table-responsive">
                <table class="table">
                  <thead class=" text-primary">
                    ...
                    <th>
                      No Prácticas o Tecnologías Innovadoras
                     </th>
                ...
                <!---Listar Usuarios-->
                  ...
                  <tbody> 
                    @foreach($innovacions as $fn)
                    <tr>
        

                    <td>{{$fn->id_innovacion}}</td>
                    <td>{{$fn->practicas}}</td>
                    <td>{{$fn->desempeño}}</td>
                      <td>{{$fn->IdUnidad}}</td>

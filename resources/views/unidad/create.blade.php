...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">Crear Unidad Productiva</h4>
  ...
  <div class="form-group">
    <label>Nombre del Responsable de la Unidad</label>
    <input type="text" class="form-control" name="nombre_representante" maxlength="50" required onkeypress="return soloLetras(event)" >
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="nombre_finca" required onkeypress="return soloLetras(event)">
  </div>

  <div class="form-group">
    <label>Nombre de la Vereda</label>
    <input type="text" class="form-control" name="vereda" required onkeypress="return soloLetras(event)" >
  </div>

  <div class="form-group">
    <label>Numero Celular</label>
    <input type="number" class="form-control" name="celular"
    onKeyDown="if(this.value.length==10) return false;" required />
  </div>

  <div class="form-group">
    <label>ingresos</label>
    <input type="number" class="form-control"  name="ingresos"   max="99.999.999">
  </div>    

  <div class="form-group">
    <label>Egresos</label>
    <input type="number" class="form-control" name="Egresos"  max="99.999.999">
  </div>
  ...
  <div class="form-group">
    ...
    <select name="municipio_id" class="form-control">
      ...
      @foreach($municipio as $und)
      <option value="{{$und->id_municipio}}"> {{$und->municipio}}</option>
      @endforeach
    </select>

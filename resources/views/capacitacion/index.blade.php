      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR 12) CAPACITACIÓN Y GESTIÓN DE CONOCIMIENTO</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/capacitacion/create" class="btn btn-sm btn-primary">Agregar  GESTIÓN DE CONOCIMIENTO</a>
                </div>
              </div>
              <div class="table-responsive">
                ...
                <!---Listar Usuarios-->
                  ...
                  <tbody> 
                    @foreach($capacitacions as $fn)
                    <tr>
        

                    <td>{{$fn->id_capacitacion}}</td>
                    <td>{{$fn->capacitacion}}</td>
                    <td>{{$fn->desempeño}}</td>
                      <td>{{$fn->IdUnidad}}</td>

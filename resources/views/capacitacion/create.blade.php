...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">12) CAPACITACIÓN Y GESTIÓN DE CONOCIMIENTO</h4>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label>No Capacitaciones/Año</label>
      <input type="number" step="any" class="form-control"  name="capacitacion" min="0" max="10000" required>

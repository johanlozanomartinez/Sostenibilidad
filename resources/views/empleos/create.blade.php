...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">9) CANTIDAD Y CALIDAD DE EMPLEOS REQUERIDOS</h4>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label>No Empleos Familiares</label>
      <input type="number" step="any" class="form-control"  name="empleo_familias" min="0" max="10000" required>
    ...
    <div class="form-group">
      <label>No Empleos Externos</label>
      <input type="number" step="any" class="form-control"  name="empleo_externos" min="0" max="10000" required>
    </div>  
  </div>

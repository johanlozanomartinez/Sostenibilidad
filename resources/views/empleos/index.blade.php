      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR 9) CANTIDAD Y CALIDAD DE EMPLEOS REQUERIDOS</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/empleos/create" class="btn btn-sm btn-primary">Agregar Cantidad y Calidad de Empleos</a>
                </div>
              </div>
              <div class="table-responsive">
                ...
                <!---Listar Usuarios-->
                  ...
                  <tbody> 
                    @foreach($empleos as $fn)
                    <tr>
        

                    <td>{{$fn->id_empleos}}</td>
                    <td>{{$fn->empleo_familias}}</td>
                    <td>{{$fn->empleo_externos}}</td>
                    <td>{{$fn->total_empleos}}</td>
                    <td>{{$fn->empleoFamiliar}}</td>
                    <td>{{$fn->desempeño}}</td>
                      <td>{{$fn->IdUnidad}}</td>

...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">6) CALIDAD DEL SUELO</h4>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <select name="id_caracteristicas" class="form-control">
        <option disabled>Seleccione la Caracteristica</option>
        @foreach($caracteristicas as $caract)
        <option value="{{$caract->id_caracteristicas}}"> {{$caract->nombre_caracteristicas}} - Nombre Caracteristica : {{$caract->nombre_caracteristicas}} </option>
        @endforeach
      </select>
    ...
    <div class="form-group">
      <label> valor</label>
      <input type="number" step="any" class="form-control"  name="valor" min="0" max="10000" required>
    </div>   

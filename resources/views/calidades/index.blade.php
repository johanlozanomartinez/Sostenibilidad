      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR 6) CALIDAD DEL SUELO</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/calidades/create" class="btn btn-sm btn-primary">Agregar  CALIDAD DEL SUELO</a>
                </div>
              </div>
              <div class="table-responsive">
                <table class="table">
                  <thead class=" text-primary">
                    ...
                    <th>Codigo Caracteritica</th>
                    <th>Nombre Caracteristica</th>
                    <th>Opciones</th>
                <!---Listar Usuarios-->
                  </tr></thead>
                  <tbody> 
                    @foreach($calidades as $fn)
                    <tr>
        

  
                    <td>{{$fn->id_calidades}}</td>
                    <td>{{$fn->valor}}</td>
                    <td>{{$fn->desempeño}}</td>
                      <td>{{$fn->IdUnidad}}</td>
                      <td>{{$fn->NombreFinca}}</td>
                      <td>{{$fn->IdCaracteristicas}}</td>
                      <td>{{$fn->Nombrecaracteristicas}}</td>

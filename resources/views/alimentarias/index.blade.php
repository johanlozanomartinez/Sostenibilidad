      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR 15) SEGURIDAD ALIMENTARIA</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/alimentarias/create" class="btn btn-sm btn-primary">Agregar  SEGURIDAD ALIMENTARIA</a>
                </div>
              </div>
              <div class="table-responsive">
                <table class="table">
                  <thead class=" text-primary">
                    ...
                    <th>
                      Alimentos Provenientes de Finca  ($)                   
                    </th>
                    
              
                    <th>
                      Alimentos No Provenientes de Finca ($)
                ...
                <!---Listar Usuarios-->
                  ...
                  <tbody> 
                    ...
                    <td>{{$fn->id_alimentarias}}</td>
                    <td>{{number_format($fn->valor_alimentos)}}</td>
                    <td>{{number_format($fn->no_alimentos)}}</td>
                    <td>{{number_format($fn->valor)}}</td>
                    <td>{{$fn->provenientes}}</td>
                    <td>{{$fn->desempeño}}</td>
                      <td>{{$fn->IdUnidad}}</td>

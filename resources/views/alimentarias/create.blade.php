                      ...
                      <ul class="nav">
                        ...
                        <li class="nav-item   ">
                          <a class="nav-link" href="{{ route('innovacion.index') }}">
                            ...
                            <span class="sidebar-normal"> {{ __('Innovacion Tecnologica ') }} </span>
                          </a>
                        </li>
                        ...
                        <li class="nav-item  ">
                          <a class="nav-link" href="{{ route('capacitacion.index') }}">
                            <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
                            <span class="sidebar-normal"> {{ __('Gestion Conocimiento') }} </span>
                          </a>
                        </li>
                ...
                <ul class="nav">
                  ...
                  <li class="nav-item  ">
                    <a class="nav-link" href="{{ route('dependencias.index') }}">
                      <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
                      <span class="sidebar-normal"> {{ __('Dependencia Insumos ') }} </span>
                    </a>
                  </li>
                  ...
                  <li class="nav-item ">
                    <a class="nav-link" href="{{ route('ahorros.index') }}">
                      <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
                      <span class="sidebar-normal"> {{ __('Ahorro Interno') }} </span>
                    </a>
                  </li>
                  ...
                  <li class="nav-item  active ">
                    <a class="nav-link" href="{{ route('alimentarias.index') }}">
                      <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
                      <span class="sidebar-normal"> {{ __('Seguridad Alimentaria') }} </span>
                    </a>
                  </li>
...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">15) SEGURIDAD ALIMENTARIA</h4>

            </div>
            <div class="card-body">
            
            <form action="/alimentarias" method="POST">
            @csrf
  <div class="form-group">
    ...
    <div class="form-group">
      <label>Valor Alimentos Provenientes de Finca ($)</label>
      <input type="number" step="any" class="form-control"  name="valor_alimentos" min="0" required>
    </div>   

      
    
    <div class="form-group">
      <label>Valor Alimentos No Provenientes de Finca ($)</label>
      <input type="number" step="any" class="form-control"  name="no_alimentos" min="0" required>
    </div>   

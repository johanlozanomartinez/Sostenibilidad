      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR 8) USO DE SEMILLAS LOCALES</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/semillas/create" class="btn btn-sm btn-primary">Agregar Semillas Locales</a>
                </div>
              </div>
              <div class="table-responsive">
                ...
                <!---Listar Usuarios-->
                  ...
                  <tbody> 
                    @foreach($semillas as $fn)
                    <tr>




                    <td>{{$fn->id_semillas}}</td>
                    <td>{{$fn->semilla_local}}</td>
                    <td>{{$fn->semilla_comercial}}</td>
                    <td>{{$fn->total_semillas}}</td>
                    <td>{{$fn->indice_semillas}}</td>
                    <td>{{$fn->desempeño}}</td>
                      <td>{{$fn->IdUnidad}}</td>

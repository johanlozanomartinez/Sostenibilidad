                      ...
                      <ul class="nav">
                        ...
                        <li class="nav-item  ">
                          <a class="nav-link" href="{{ route('empleos.index') }}">
                            <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
                            <span class="sidebar-normal"> {{ __('Cantidad de Empleos ') }} </span>
                          </a>
                        </li>
...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">8) USO DE SEMILLAS LOCALES</h4>

            </div>
            <div class="card-body">
            
            <form action="/semillas" method="POST">
            @csrf
  <div class="form-group">
    ...
    <div class="form-group">
      <label>Semilla Local</label>
      <input type="number" step="any" class="form-control"  name="semilla_local" min="0" max="10000" required>
    ...
    <div class="form-group">
      <label>Semilla Comercial</label>
      <input type="number" step="any" class="form-control"  name="semilla_comercial" min="0" max="10000" required>
    </div>  

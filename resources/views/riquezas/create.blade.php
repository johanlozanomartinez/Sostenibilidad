...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">RIQUEZA Y DIVERSIDAD DE ESPECIES</h4>

            </div>
            <div class="card-body">
            
            <form action="/riquezas" method="POST">
            @csrf
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <select name="id_especies" class="form-control">
        <option disabled>Seleccione la Especie</option>
        @foreach($especies as $caract)
        <option value="{{$caract->id_especies}}"> {{$caract->nombre_especies}} - Nombre Especies : {{$caract->nombre_especies}} </option>
        @endforeach
      </select>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="number" step="any" class="form-control"  name="cantidad" min="0" max="10000" required>
    </div>   

      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR 7) RIQUEZA Y DIVERSIDAD DE ESPECIES</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="riquezas/create" class="btn btn-sm btn-primary">Agregar  RIQUEZA Y DIVERSIDAD DE ESPECIES</a>
                </div>
              </div>
              <div class="table-responsive">
                <table class="table">
                  <thead class=" text-primary">
                    ...
                    <th>Codigo Especies</th>
                    <th>Nombre Especies</th>
                    <th>Opciones</th>
                <!---Listar Usuarios-->
                  </tr></thead>
                  <tbody> 
                    @foreach($riquezas as $fn)
                    <tr>
                    <td>{{$fn->id_riquezas}}</td>
                    <td>{{$fn->cantidad}}</td>
                    <td>{{$fn->abundancia}}</td>
                    <td>{{$fn->log}}</td>
                    <td>{{$fn->pi}}</td>
                    <td>{{$fn->biodiversidad}}</td>
                      <td>{{$fn->IdUnidad}}</td>
                      <td>{{$fn->NombreFinca}}</td>
                      <td>{{$fn->IdEspecies}}</td>
                      <td>{{$fn->Nombreespecies}}</td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>

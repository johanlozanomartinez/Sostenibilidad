          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="col-12 text-right">
                  <a href="/user/create" class="btn btn-sm btn-primary">Agregar Usuarios</a>
                </div>
              </div>
...
<button class="btn btn-danger" type="submit" title="delete" style="border: none; background-color:transparent;">

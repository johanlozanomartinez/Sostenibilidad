...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">5) CANTIDAD DE AGUA POR UNIDAD DE SUPERFICIE</h4>

            </div>
            <div class="card-body">
            
            <form action="/agua" method="POST">
            @csrf
  <div class="form-group">
    ...
    <div class="form-group">
      <label>Disponibilidad Agua</label>
      <input type="number" step="any" class="form-control"  name="disponibilidad_agua" min="0" max="10000" required>
    ...
    <div class="form-group">
      <label>capacidad_recarga</label>
      <input type="number" step="any" class="form-control"  name="capacidad_recarga" min="0" max="10000" required>
    </div>  

      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR 5) CANTIDAD DE AGUA POR UNIDAD DE SUPERFICIE</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/agua/create" class="btn btn-sm btn-primary">Agregar Cantidad de agua</a>
                </div>
              </div>
              <div class="table-responsive">
                ...
                <!---Listar Usuarios-->
                  ...
                  <tbody> 
                    ...
                    <td>{{$fn->id_agua}}</td>
                    <td>{{$fn->disponibilidad_agua}}</td>
                    <td>{{$fn->capacidad_recarga}}</td>
                    <td>{{$fn->desempeño_disponibilidad}}</td>
                    <td>{{$fn->desempeño_capacidad}}</td>
                    <td>{{$fn->promedio_desempeño}}</td>
                      <td>{{$fn->IdUnidad}}</td>

                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse show" id="laravelExample">
                      <ul class="nav">
                        ...
                        <li class="nav-item ">
                          <a class="nav-link" href="{{ route('valor') }}">
                            <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
                            <span class="sidebar-normal"> {{ __('Valor Neto') }} </span>
                          </a>
                        </li>
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">Listar Fincas</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/finca/create" class="btn btn-sm btn-primary">Add Finca</a>
                </div>
              </div>
              <div class="table-responsive">
                ...
                <!---Listar Usuarios-->
                  ...
                  <tbody> 
                    @foreach($finca as $fn)
                    <tr>
                    <td>{{$fn->identificacion}}</td>
                    <td>{{$fn->nombre_representante}}</td>
                    <td>{{$fn->nombre_finca}}</td>
                    <td>{{$fn->municipio}}</td>
                    <td>{{$fn->vereda}}</td>
                    <td>{{$fn->celular}}</td>

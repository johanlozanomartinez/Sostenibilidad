                    ...
                    <div class="collapse show" id="laravelExample">
                      <ul class="nav">
                        ...
                        <li class="nav-item active">
                          <a class="nav-link" href="{{ route('finca.create') }}">
                            <i><img style="width:25px" src="{{ asset('material') }}/img/finca_registro.png"></i>
                            <span class="sidebar-normal">{{ __('Crear Finca') }} </span>
                          </a>
                        </li>
                        
                        <li class="nav-item">
                          <a class="nav-link" href="{{ route('finca.index') }}">
                            <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
                            <span class="sidebar-normal"> {{ __('Listar Fincas') }} </span>
                          </a>
                        </li>
                      </ul>
                    </div>
...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">Asignar Valor Neto</h4>

            </div>
            <div class="card-body">
            
            <form action="/valor_neto" method="POST">
            @csrf
  <div class="form-group">
    ...
    <div class="form-group">
      <label>FNC</label>
      <input type="text" class="form-control" name="FNC">
    </div>

    <div class="form-group">
      <label>VPN</label>
      <input type="text" class="form-control" name="VPN">
    </div>

    <div class="form-group">
      <label>porcentaje</label>
      <input type="text" class="form-control" name="Porsentaje">
    </div>

    <div class="form-group">
      <label>Desempeño</label>
      <input type="text" class="form-control" name="Desempeño">
    </div>

...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">Crear Finca</h4>
  ...
  <div class="form-group">
    <label>nombre_representante</label>
    <input type="text" class="form-control" name="nombre_representante">
  </div>

  <div class="form-group">
    <label>nombre_finca</label>
    <input type="text" class="form-control" name="nombre_finca">
  </div>
  ...
  <div class="form-group">
    <label>vereda</label>
    <input type="text" class="form-control" name="vereda">
  </div>

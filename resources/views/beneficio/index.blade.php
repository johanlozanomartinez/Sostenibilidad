      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR BENEFICIO COSTO (B/C)</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/beneficio/create" class="btn btn-sm btn-primary">ADD Beneficio Costo</a>
                </div>
              </div>
              <div class="table-responsive">
                ...
                <!---Listar Usuarios-->
                  ...
                  <tbody> 
                    @foreach($beneficio as $fn)
                    <tr>
                    <td>{{$fn->id_beneficio}}</td>
                    <td>{{number_format($fn->ingresos)}}</td>
                    <td>{{number_format($fn->Egresos)}}</td>
                    <td>{{number_format($fn->vpningresos)}}</td>
                    <td>{{number_format($fn->vpnegresos)}}</td>
                    <td>{{$fn->BC}}</td>
                    <td>{{$fn->Desempeño}}</td> 
                      <td>{{$fn->IdUnidad}}</td>

      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">ASIGNAR BENEFICIO COSTO (B/C)</h4>

            </div>
            <div class="card-body">
            
            <form action="/beneficio" method="POST">
            @csrf
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <select name="id_unidad" class="form-control">
        ...
        <option value="{{$und->id_unidad}}"> {{$und->nombre_finca}} - Nombre Representante : {{$und->nombre_representante}} -ingresos: {{$und->ingresos}} -Egresos: {{$und->Egresos}}</option>
        @endforeach
      </select>
    ...
    <script>
      ...
      let formato=accounting.formatMoney(5466756);
      document.getElementById('resultado').innerText = formato;


      formato = accounting.formatMoney(1237.95,'e',2,'.',',');
      document.getElementById('resultado').innerText = formato;

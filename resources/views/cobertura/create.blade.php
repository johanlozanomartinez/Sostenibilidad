                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse show" id="laravelExample">
                      <ul class="nav">
                        ...
                        <li class="nav-item   ">
                          <a class="nav-link" href="{{ route('presion.index') }}">
                            <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">ASIGNAR COBERTURA VEGETAL</h4>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label>Area Agricola</label>
      <input type="number" step="any" class="form-control"  name="agricola" min="0" max="100" required>
    ...
    <div class="form-group">
      <label>Area Pecuaria</label>
      <input type="number" step="any" class="form-control"  name="pecuaria" min="0" max="100" required>
    </div>  

 <div class="form-group">
      <label>Area Forestal</label>
      <input type="number" step="any"   class="form-control"  name="forestal" min="0" max="100"  required>
    </div> 

    <div class="form-group">
      <label>Cobertura Agricola</label>
      <input type="number" class="form-control"  name="coberturaAgricola" required>
    </div> 

    <div class="form-group">
      <label>Cobertura Pecuaria</label>
      <input type="number" class="form-control"  name="coberturaPecuaria"  required>
    </div> 

    <div class="form-group">
      <label>Cobertura Forestal</label>
      <input type="number" class="form-control"  name="coberturaForestal"  required>
    </div> 

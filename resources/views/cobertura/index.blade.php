                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse show" id="laravelExample">
                      <ul class="nav">
                        ...
                        <li class="nav-item   ">
                          <a class="nav-link" href="{{ route('plagas.create') }}">
                            <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">COBERTURA VEGETAL</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/cobertura/create" class="btn btn-sm btn-primary">Agregar  Cobertura Vegetal</a>
                </div>
              </div>
              <div class="table-responsive">
                ...
                <!---Listar Usuarios-->
                  ...
                  <tbody> 
                    @foreach($cobertura as $fn)
                    <tr>




                    <td>{{$fn->id_cobertura}}</td>
                    <td>{{$fn->agricola}}</td>
                    <td>{{$fn->pecuaria}}</td>
                    <td>{{$fn->forestal}}</td>
                    <td>{{$fn->totalarea}}</td>
                    <td>{{$fn->coberturaAgricola}}</td>
                    <td>{{$fn->coberturaPecuaria}}</td>
                    <td>{{$fn->coberturaForestal}}</td>
                    <td>{{$fn->ponderadoAgricola}}</td>
                    <td>{{$fn->ponderadoPecuaria}}</td>
                    <td>{{$fn->ponderadoForestal}}</td>
                    <td>{{$fn->coberturaVegetal}}</td>
                    <td>{{$fn->Desempeño}}</td> 
                      <td>{{$fn->IdUnidad}}</td>

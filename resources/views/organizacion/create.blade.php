                      ...
                      <ul class="nav">
                        ...
                        <li class="nav-item  ">
                          <a class="nav-link" href="{{ route('empleos.index') }}">
                            ...
                            <span class="sidebar-normal"> {{ __('Cantidad de Empleados ') }} </span>
                          </a>
                        </li>
                        ...
                        <li class="nav-item active ">
                          <a class="nav-link" href="{{ route('organizacion.index') }}">
                            <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
                            <span class="sidebar-normal"> {{ __('Particiacion en Organizaciones') }} </span>
                          </a>
                        </li>
                      ...
                      <ul class="nav">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="{{ route('agua.index') }}">
                            <i><img style="width:25px" src="{{ asset('material') }}/img/regist_finc.png"></i>
                            <span class="sidebar-normal"> {{ __('Gestion de Conocimiento') }} </span>
                          </a>
                        </li>
...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">10) PARTICIPACIÓN EN ORGANIZACIONES LOCALES</h4>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label>No Asociaciones Municipio</label>
    ...
    <div class="form-group">
      <label>No Asociaciones que Participa</label>

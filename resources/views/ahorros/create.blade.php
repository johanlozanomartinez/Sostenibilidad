...
<div class="container-fluid">
      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">14) AHORRO INTERNO (AI)</h4>

            </div>
            <div class="card-body">
            
            <form action="/ahorros" method="POST">
            @csrf
  <div class="form-group">
    ...
    <div class="form-group">
      <label>Costo Cubierto Sin Préstamos ($)</label>
      <input type="number" step="any" class="form-control"  name="sin_prestamo" min="0" required>
    </div>   
    ...
    <div class="form-group">
      <label>Costo Cubierto Sin Préstamos ($)</label>
      <input type="number" step="any" class="form-control"  name="con_prestamo" min="0" required>
    </div>   

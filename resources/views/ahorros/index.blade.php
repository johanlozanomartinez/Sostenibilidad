      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title ">LISTAR 14) AHORRO INTERNO (AI)</h4>

            </div>
            <div class="card-body">
                              <div class="row">
                <div class="col-12 text-right">
                  <a href="/ahorros/create" class="btn btn-sm btn-primary">Agregar  AHORRO INTERNO</a>
                </div>
              </div>
              <div class="table-responsive">
                <table class="table">
                  <thead class=" text-primary">
                    ...
                    <th>
                      Cubierto Sin Préstamos ($)                   
                    </th>
                    
              
                    <th>
                      Cubierto Con Préstamos ($)
                ...
                <!---Listar Usuarios-->
                  ...
                  <tbody> 
                    ...
                    <td>{{$fn->id_ahorros}}</td>
                    <td>{{number_format($fn->sin_prestamo)}}</td>
                    <td>{{number_format($fn->con_prestamo)}}</td>
                    <td>{{number_format($fn->total)}}</td>
                    <td>{{$fn->costo_cubierto}}</td>
                    <td>{{$fn->desempeño}}</td>
                      <td>{{$fn->IdUnidad}}</td>
